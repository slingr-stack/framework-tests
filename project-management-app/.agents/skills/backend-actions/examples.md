...
By convention, `GlobalAction` uses `export default class`.
...
import { MyService } from '@/my-module/services/my.service';
...
import { MyEntity, MyEntityStatus } from '@/my-entities/data-models/my-entity.data-model';
...
import { MyEntity, MyEntityStatus } from '@/my-entities/data-models/my-entity.data-model';
import { ChildRecord, ChildStatus } from '@/my-entities/data-models/child-record.data-model';
import { MainDs } from '@/infra/data-sources/main.ds';
import { NotificationService } from '@/my-entities/services/notification.service';
...
import { MyEntity, MyEntityStatus } from '@/my-entities/data-models/my-entity.data-model';
import { MainDs } from '@/infra/data-sources/main.ds';
import { MyEntityService } from '@/my-entities/services/my-entity.service';
