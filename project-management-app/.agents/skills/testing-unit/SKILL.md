---
name: testing-unit
description: Essential skill for Drumr Framework unit tests. Teaches how to write isolated, deterministic unit tests using DrumrUnitTestKit and shared testing conventions without mixing unit tests with integration or E2E flows.
metadata:
  applies-to:
