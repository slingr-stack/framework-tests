...
/// <reference types="/Users/angelessgro/Documents/slingr/Untitled/framework/apps/project-management-app/frontend/node_modules/@ant-design/pro-components" />
...
import {
  ProLayout,
} from "/Users/angelessgro/Documents/slingr/Untitled/framework/apps/project-management-app/frontend/node_modules/@ant-design/pro-components";
import './Layout.css';
...
const formatMessage = undefined;
  ...
  return (
    <ProLayout
      route={route}
      location={location}
      title={userConfig.title || 'project-management-app-frontend'}
      navTheme="dark"
      siderWidth={256}
      onMenuHeaderClick={(e) => {
        e.stopPropagation();
