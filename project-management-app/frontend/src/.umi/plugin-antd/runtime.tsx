...
import merge from '/Users/angelessgro/Documents/slingr/Untitled/framework/node_modules/.pnpm/lodash@4.17.23/node_modules/lodash/merge'
...
const getAntdConfig = () => {
  if(!cacheAntdConfig){
    cacheAntdConfig = getPluginManager().applyPlugins({
      ...
      initialValue: {
        ...{"theme":{"token":{"fontFamily":"AlibabaSans, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, 'Noto Sans', sans-serif"}}},
        appConfig: {},
      },
    });
