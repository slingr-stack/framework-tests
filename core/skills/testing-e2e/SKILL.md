---
name: testing-e2e
description: Essential skill for Drumr Framework E2E tests. Teaches how to write, debug, maintain, and execute/run Playwright-driven browser tests for apps using DrumrTestKit.
metadata:
  applies-to:
...
When asked to create an authenticated E2E test, follow this sequence before writing any spec:

```text
Request: "Generate an authenticated E2E test for Tasks"

Step 1: "I need E2E credentials before generating the authenticated test."
Action: Ask the developer for:
- The email/username source.
- The password strategy/source.
...
For detailed instructions on how to properly execute E2E tests within applications (running the whole suite, a specific suite, in headed or debug mode), refer to the definitive guide:

- [Test Execution Guide](./usage/usage.md)

## 5.1 Running and Debugging
